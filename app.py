...
with col_logo:
    st.image("FDJ_engenharia.jpg", width=500)  # Use a imagem que você já adicionou
with col_titulo:
    st.markdown("<h1 style='padding-top: 200px;'>Supervisório de Medição Elétrica</h1>", unsafe_allow_html=True)
